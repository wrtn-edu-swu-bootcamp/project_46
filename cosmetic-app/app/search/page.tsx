        ...
        <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600 focus:border-gray-400 dark:focus:border-gray-500 dark:text-gray-100 dark:placeholder:text-gray-500"
            />
            <button
              onClick={searchWithAI}
              disabled={aiLoading || !aiQuery.trim()}
              className="px-5 py-3 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded-xl font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {aiLoading ? '...' : '검색'}
            </button>
          </div>
          ...
          {/* AI 응답 */}
          {aiResponse && (
            <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          {aiLoading && (
            <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-xl text-center border border-gray-200 dark:border-gray-700">
              <p className="text-gray-600 dark:text-gray-400 text-sm">AI가 분석 중이에요...</p>
            </div>
          )}
        </div>
      </div>
